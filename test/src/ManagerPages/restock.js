...
function Restock(props) {
    ...
    return (
        <Fragment>
            ...
            <div class='heading'>
                <h1>Restock</h1>
                <p>View and restock the inventory by each item or restock all items to the recommended amount</p>
                <hr></hr>
            </div>
            <Table data={inventory} column={props.column}/>
            <br></br><br></br>
            <h1>Restock Single Item </h1>
            <p>Restock a single item by entering the item ID and the amount to order</p><br></br><br></br>
            ...
            <h1>Restock All</h1>
            <p>Restock all ingredients in the inventory by the recommended amount</p><br></br><br></br>
